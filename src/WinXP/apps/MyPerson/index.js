    ...
    <Div>
      ...
      <section className="com__address_bar">
        ...
        <div className="com__address_bar__content">
          ...
          />
          <div className="com__address_bar__content__text">Felipe Sousa Nunes</div>
          <img
            src={dropdown}
            alt="dropdown"
            className="com__address_bar__content__img"
          ...
          <div className="com__content__right">
              ...
              <div className="com__content__right__card__header">
                Introdução  
                  ...
                  <div className="row px-2">
                    <div className="col-12 col-sm-5 d-flex justify-content-center mt-3">
                      <img
                        src={felipefoto}
                        alt="folder"
                        className="com__content__right__card__foto"
                      />
            ...
            <div className="com__content__right__card com__content__right__card--me">
              ...
              <div className="com__content__right__card__content">
                ...
                <a
                  href="https://www.linkedin.com/in/felipesnunes/"
                  target="_blank"
                  rel="noreferrer"
                  className="com__content__right__card__item--me"
                >
...
const Div = styled.div`
  ...
  .com__content__right__card__foto {
    width: 200px;
    height: 200px;
    margin-right: 5px;
  }
